...
const translations = {
    id: {
        ...
        logout: "Keluar",
        loginTitle: "Nameless",
        loginSubtitle: "Ruang aman untuk berbagi perasaan secara anonim",
    ...
    en: {
        // ... (Harap isi terjemahan bahasa Inggris yang setara untuk semua konten baru di atas)
        darkMode: "Dark Mode",
        lightMode: "Light Mode",
        logout: "Logout",
        loginTitle: "Nameless",
        loginSubtitle: "A safe space to share feelings anonymously",
        ...
        if (pageContentContainer) {
            ...
            switch(page) {
                ...
                case 'stats':
                    ...
                    isPremiumPage = true;
                    customLockTitle = t.premiumFeatureLockTitle; // Menggunakan judul spesifik untuk overlay Statistik
                    customLockMessage = t.premiumFeatureLockMessage; // Menggunakan pesan spesifik
                    break;
                ...
                default: titleKey = "pageTitleNotFound"; contentKey = "pageContentNotFound";
                    if (!t[titleKey]) t[titleKey] = "Halaman Tidak Ditemukan"; // Fallback jika belum ada di translations
                    if (!t[contentKey]) t[contentKey] = "<p>Maaf, konten untuk halaman ini tidak tersedia.</p>";
            }
